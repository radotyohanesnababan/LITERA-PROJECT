        ...
        <form class=" mx-auto mt-6 " method="POST" action="{{ route('editStaff', $staff->id) }}"
            ...
            <div class="mb-5">
                ...
                <select id="posisi" name="posisi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    required>
                    <option value="" disabled {{ $staff->posisi == '' ? 'selected' : '' }}>Pilih posisi</option>
                    <option value="Manajemen" {{ $staff->posisi == 'Manajemen' ? 'selected' : '' }}>Manajemen</option>
                    <option value="Tenaga Tutor" {{ $staff->posisi == 'Tenaga Tutor' ? 'selected' : '' }}>Tenaga Tutor
                    </option>
                </select>
            ...
            <div class="mb-5">
                ...
                <input type="sub_posisi" id="sub_posisi" name="sub_posisi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    value="{{ $staff->sub_posisi }}" required />
            </div>
            <div class="mb-5">
                ...
                <input
                    ...
                    value="{{ $staff->foto }}" name="foto" id="foto" type="file">
            </div>
            <button type="submit"
