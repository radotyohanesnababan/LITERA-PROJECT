<div>
    ...
    <div class="sm:rounded-lg w-4/5 bg-gray-200 shadow-md mx-auto mt-0 p-7">
        <form class=" mx-auto mt-6 " method="POST" action="{{ route('addStaff') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                ...
                <select id="posisi" name="posisi"
                    ...
                    <option value="Tenaga Tutor">Tenaga Tutor</option>
                </select>
            </div>
            <div class="mb-5">
                <label for="sub_posisi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subposisi</label>
                <input type="sub_posisi" id="sub_posisi" name="sub_posisi"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    required />
            </div>
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" id="foto" name="foto">Upload foto</label>
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" name="foto" id="foto" type="file" required>
