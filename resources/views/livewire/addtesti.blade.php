    ...
    <x-slot name="header">
        <div class="sm:rounded-lg w-auto bg-slate-200 mx-auto">
            ...
            <h3 class=" p-2 font-weight-400 text-l text-gray-800 leading-tight">
                Halaman Tambah Testimoni
            </h3>
        </div>
    </x-slot>
    <div class="sm:rounded-lg w-4/5 bg-gray-200 shadow-md mx-auto mt-0 p-7">
        <form class=" mx-auto mt-6 " method="POST" action="{{ route('addTesti') }}" enctype="multipart/form-data">
            @csrf
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label for="message" id="deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi Testimoni</label>
                <textarea id="message" rows="4" name="deskripsi" id="deskripsi"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Tuliskan testimoni disini ..."></textarea>
            </div>
            <div class="mb-5">
