...
@section('content')
    <body class="bg-white">
        <div>
            <h1 class="text-[#31081F] py-10 md:py-20 font-bold text-2xl md:text-4xl lg:text-5xl xl:text-6xl text-center">GALERI KEGIATAN</h1>
        </div>

        <div class="pb-5 md:pb-20">
            <a href="/halaman1" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Kelas Praktek
            </a>
            <a href="/halaman2" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Outbond
            </a>
            <a href="/halaman3" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Buka Puasa Bersama
            </a>
            <a href="/halaman4" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Reguler Learning
            </a>
            <a href="/halaman5" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Outdoor Learning
            </a>
            <a href="/halaman6" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Audio Visual Learning
            </a>
            <a href="/halaman7" class="block text-[#31081F] font-bold text-xl md:text-2xl lg:text-3xl xl:text-4xl text-center pb-5 hover:underline">
                Flashcard Learning
            </a>            
        </div>
